...
class RomanNumeralConverterSpec extends ObjectBehavior
{
	...
	function it_calculate_the_roman_numeral_for_5()
	{
		$this->convert(5)->shouldReturn('V');
	}

	function it_calculate_the_roman_numeral_for_6()
	{
		$this->convert(6)->shouldReturn('VI');
	}

	function it_calculate_the_roman_numeral_for_9()
	{
	...
	function it_calculate_the_roman_numeral_for_11()
	{
	...
	function it_calculate_the_roman_numeral_for_50()
	{
	...
	function it_calculate_the_roman_numeral_for_500()
	{
		$this->convert(500)->shouldReturn('D');
	}

	function it_calculate_the_roman_numeral_for_1000()
	{
		$this->convert(1000)->shouldReturn('M');
	}

	function it_calculate_the_roman_numeral_for_1999()
	{
		$this->convert(1999)->shouldReturn('MCMXCIX');
	}

	function it_calculate_the_roman_numeral_for_4991()
	{
		$this->convert(4991)->shouldReturn('MMMMCMXCI');
	}
}
